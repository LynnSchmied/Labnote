...
df.yfp <- read.csv('results_17.csv') %>%  # results 17.03.2021, 20th frame stimulation
          select(-c('rel')) %>%
          rbind(read.csv('results_10.csv'),  # results 22,27.01.2021, 10th frame stimulation
          read.csv('results_20.csv')) #,  # results 22,27.01.2021, 20th frame stimulation
          
df.mask <- subset(df.yfp, mask == 'up')
